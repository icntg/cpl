...
namespace cpl {
    namespace win32 {
        namespace service {
            ...
            public:
                WindowsService* (*funcGetInstance)();
            };
            ...
            protected:
                ...
                static WindowsService* (*funcGetInstance)();
...
//                void (WINAPI *funcServiceCtrlHandler)(DWORD controlCode){};
            ...
            public:
                static void WINAPI ServiceMainWrapper(DWORD argc, LPWSTR* argv) {
                    if (funcGetInstance) {
                        funcGetInstance()->ServiceMain(argc, argv);
                    }
                }
...
//                    }
                ...
                static void WINAPI ControlHandlerWrapper(DWORD controlCode) {
                    if (funcGetInstance) {
                        funcGetInstance()->ControlHandler(controlCode);
                    }
                }
                ...
                int32_t Run() {
                    SERVICE_TABLE_ENTRYW serviceTable[] = {
                            { (LPWSTR)serviceName.data(), ServiceMainWrapper },
                            { nullptr, nullptr }
                    };
...
//                $Status status{};
//
//                static $Status* (*funcGetInstance)();
//
//            public:
//                static void WINAPI ServiceMainWrapper(DWORD argc, LPSTR* argv) {
//                    if (funcGetInstance) {
//                        funcGetInstance()->ServiceMain(argc, argv);
//                    }
//                }
