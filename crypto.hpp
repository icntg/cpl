...
namespace cpl {
    namespace crypto {
        ...
        public:
            ...
            static constexpr cpl::Error::CodeDef SHA256_ = {base | 1};
            static constexpr cpl::Error::CodeDef HMAC256_ = {base | 2};
            static constexpr cpl::Error::CodeDef LENGTH_ENCODE_ = {base | 3};
            static constexpr cpl::Error::CodeDef CREATE_RC4_ = {base | 0x20};
        };
            ...
            namespace impl {
                ...
                public:
                    explicit Crypto_RC4_HMAC256(const Stream &key, cpl::crypto::IRandom *randomProvider = nullptr) {
                        this->crypto = std::make_unique<cpl::crypto::impl::Crypto_RC4_HMAC256>(key, randomProvider);
                    }
